...
This neovim plugin provides a [blink.cmp](https://github.com/saghen/blink.cmp) source for completing
...
require'blink-cmp'.setup {
  sources = {
    -- ...
    per_filetype = { markdown = { "nixpkgs_maintainers" } },
    providers = {
      -- ...
      nixpkgs_maintainers = {
...
- This plugin is a port of my previous [cmp-nixpkgs-maintainers](https://github.com/GaetanLepage/cmp-nixpkgs-maintainers) plugin.
